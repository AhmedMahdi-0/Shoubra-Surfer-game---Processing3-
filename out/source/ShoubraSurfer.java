...
public class ShoubraSurfer extends PApplet {
...
public int Random() {
	int T = PApplet.parseInt(random(0,3));
	if (T == 1) {
		return 175;
	}
	else if (T == 2) {
...
public void draw() {
	...
	/**********************************************/
  	// Open Screen Section
	if (PApplet.parseInt(startTimer.getTime())>15)	{
	...
	/**********************************************/
  	// Play Section
	if (PApplet.parseInt(startTimer.getTime())<= 15 && startTimer.getTime()>= 0) {
		...
		if (Cy1 >= height) {
			Cx1 = Random();
			Cy1 = PApplet.parseInt(random(- 80 , - 70));
		}
		if (Cy2 >= height) {
			Cx2 = Random();
			Cy2 = PApplet.parseInt(random(- 150 , - 130));
		}
		if (Cy3 >= height) {
			Cx3 = Random();
			Cy3 = PApplet.parseInt(random(- 230 , - 200));
		}
		...
		textFont(font);
		textSize(18);
		text("Time Left:" + PApplet.parseInt(startTimer.getTime()),10,10,110,100);
...
class Timer
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "ShoubraSurfer" };
    if (passedArgs != null) {
